  ...
  jQuery.noConflict();
	...
	**********************************************************************/
	...
	$('form.jcart').submit(function(){
		...
		var itemArticle = $(this).find('input[name=<?php echo $jcart['item_article']?>]').val();
		var itemPrice = $(this).find('input[name=<?php echo $jcart['item_price']?>]').val();
		var itemTax = $(this).find('input[name=<?php echo $jcart['item_tax']?>]').val();
