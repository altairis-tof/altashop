...
if(!isset($context['embedded']) || ($context['embedded'] == 'prefix')) {
	...
	echo "\t".'<link rel="stylesheet" href="'.$context['url_to_root'].'skins/alta_digital/alta_digital.css" type="text/css" media="all" />'."\n";

	// nice titles
	echo "\t".'<link rel="stylesheet" href="'.$context['url_to_root'].'skins/alta_digital/nicetitle.css" type="text/css" media="all" />'."\n";
	...
	if(!$context['site_icon']) {
		echo "\t".'<link rel="shortcut icon" href="'.$context['url_to_root'].'skins/alta_digital/squares.ico" type="image/x-icon" />'."\n";
		echo "\t".'<link rel="icon" href="'.$context['url_to_root'].'skins/alta_digital/squares.ico" type="image/x-icon" />'."\n";
	}

	// other head directives
	echo $context['page_header'];

	// firefox potential cache problem corrected with these 3 lines
...
if(!isset($context['embedded']) || ($context['embedded'] == 'suffix')) {
	...
	// nice titles
	echo "\t".'<script type="text/javascript" src="'.$context['url_to_root'].'skins/alta_digital/nicetitle.js"></script>'."\n";
